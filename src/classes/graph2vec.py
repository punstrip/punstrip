...
class Graph2Vec():
    ...
    def train(self, graphs, model_path=None, model_dimensions=128):
        ...
        cmd="graph2vec# python3 src/graph2vec.py --input-path {}/graph2vec/ --output-path {} --workers 128 --dimensions {} --epochs 50 --wl-iterations 3".format(self.config.res, model_path, model_dimensions)

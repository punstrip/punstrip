...
#Expressions generated with
"""
db.symbols.aggregate([ { '$project' : { 'expressions' : {  '$objectToArray' : '$vex.sum_expressions' } } },  { '$unwind': '$expressions'  }, { '$project' : {'expr' : '$expressions.k' } }, { '$group' : { '_id' : '$expr' } } ])
"""


def create_vectorised_symbols(FROM_COL_NAME, TO_COL_NAME):
